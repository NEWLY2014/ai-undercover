...
// Ported visually from the original demo's `S` object so the look is preserved.
// CSS variables + keyframes live in globals.css. A readability pass raised the
// smallest font sizes to a ~12px floor, added line-height to multi-line blocks,
// dropped opacity-stacking on muted text, and routed error/spy TEXT to --danger.
export const S: Record<string, CSSProperties> = {
  ...
  kicker: { fontFamily: mono, letterSpacing: 3, fontSize: 11.5, color: "var(--amber)", textTransform: "uppercase" },
  ...
  toggle: { display: "flex", flexWrap: "wrap", gap: 8 },
  ...
  seats: { display: "flex", flexDirection: "column", gap: 12 },
  ...
  cardTrait: { fontSize: 12, color: "var(--muted)", marginTop: 1 },
  cardWord: { fontSize: 12.5, fontWeight: 700, marginTop: 7, fontFamily: mono, letterSpacing: 0.5 },
  cardClue: { fontSize: 12.5, color: "var(--ink)", marginTop: 7, fontStyle: "italic", lineHeight: 1.5 },
  speakTag: { fontFamily: mono, fontSize: 12, color: "var(--amber)", marginTop: 6, animation: "pulse 1s infinite" },
  voteTag: { fontFamily: mono, fontSize: 12, color: "var(--muted)", marginTop: 6 },
  ...
  phaseTag: { fontFamily: mono, fontSize: 11.5, color: "var(--amber)", background: "rgba(232,161,58,.10)", border: "1px solid var(--amber-dim)", borderRadius: 999, padding: "3px 10px" },
  feed: { flex: 1, overflowY: "auto", padding: "12px 14px", display: "flex", flexDirection: "column", gap: 12, maxHeight: 440 },
  thinking: { fontFamily: mono, fontSize: 12.5, color: "var(--muted)", display: "flex", alignItems: "center", marginTop: 2 },

  logSystem: { fontSize: 12.5, color: "var(--muted)", fontStyle: "italic", animation: "fadeUp .3s" },
  ...
  logName: { fontSize: 12, color: "var(--muted)", marginBottom: 2 },
  bubble: { background: "var(--panel2)", border: "1px solid var(--line)", borderRadius: "2px 11px 11px 11px", padding: "7px 11px", fontSize: 13.5, lineHeight: 1.55, maxWidth: 360 },
  reasoning: { fontSize: 12.5, color: "var(--muted)", marginTop: 4, fontStyle: "italic", lineHeight: 1.55, paddingLeft: 6, borderLeft: "2px solid var(--line)" },
  ...
  logElim: { fontSize: 13, lineHeight: 1.5, padding: "9px 11px", borderWidth: 1, borderStyle: "solid", borderColor: "var(--line)", borderLeftWidth: 3, borderRadius: 8, background: "rgba(0,0,0,.2)", animation: "fadeUp .3s" },
  ...
  errorBox: { fontSize: 12.5, color: "var(--danger)", background: "rgba(223,75,66,.10)", border: "1px solid var(--red)", borderRadius: 8, padding: "8px 10px", margin: "0 14px 12px", lineHeight: 1.5 },
  ...
  chipSpy: { borderColor: "var(--red)", color: "var(--danger)", background: "rgba(223,75,66,.10)" },
  ...
  wordsTitle: { fontSize: 12, color: "var(--muted)", marginBottom: 6 },
  wordsRow: { display: "flex", gap: 14, fontFamily: mono, fontSize: 13 },
  wordCiv: { color: "var(--amber)" },
  wordSpy: { color: "var(--danger)" },

  footer: { textAlign: "center", color: "var(--muted)", fontSize: 12, marginTop: 16, paddingTop: 10, borderTop: "1px solid var(--line)" },
};
